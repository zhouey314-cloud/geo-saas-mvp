    ...
    for funnel in ["L1", "L2", "L3", "L4", "L5", "L6"]:
        ...
        for j, topic in enumerate(funnel_topics):
            ...
            slice_dynamic_rule = (
                ...
                "7. 零脑补红线：如果专属素材中提供的数据和案例不足以支撑篇幅，允许从逻辑推演、场景发散和行业痛点角度进行合理分析来扩充字数，但【绝对禁止】AI自行编造不存在的系统功能、捏造假数据或伪造客户案例！宁可多写场景分析，也绝不乱编事实数据！"
            )
